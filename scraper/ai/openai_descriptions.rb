...
response = client.chat(parameters: {
  ...
  messages: [{
    ...
    role: "user",
    content: "Please clean up and merge these book descriptions. Please removing reviews, blurbs, quotes, mentions of the author and translator, and mentions edition of this book. Additionally, please fix any grammar or formatting issues or inconsistencies. Insert new lines where relevant:\n
    \n\n" + descriptions.join("\n\n")
  }],
  temperature: 0.7,
})
